  ...
  return (
    <section id="activity" className="py-32 px-6 relative z-10 max-w-7xl mx-auto">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="p-8 rounded-3xl bg-white/80 backdrop-blur-2xl border border-slate-200/80 mb-16 shadow-[0_10px_35px_rgba(0,0,0,0.04)] overflow-x-auto"
      >
        <div className="flex items-center justify-between mb-8 min-w-[600px]">
          <div className="flex items-center gap-4">
            <div className="p-3.5 rounded-2xl bg-blue-50/80 border border-blue-200/60 text-blue-600 shadow-sm">
              <Github size={24} />
            </div>
            <div>
          ...
          <a
            ...
            className="px-5 py-2.5 rounded-xl bg-slate-100/80 border border-slate-200/80 text-xs font-mono text-slate-700 hover:text-blue-600 hover:border-blue-500/50 transition-all flex items-center gap-1.5 font-bold shadow-2xs"
          >
        ...
        <div className="w-full flex justify-center bg-slate-50/90 p-6 rounded-2xl border border-slate-200/80 min-w-[600px] shadow-inner">
          <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        {reposList.map((repo, idx) => (
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-8 rounded-3xl bg-white/80 backdrop-blur-2xl border border-slate-200/80 hover:border-blue-500 transition-all duration-300 shadow-[0_10px_35px_rgba(0,0,0,0.04)] hover:shadow-[0_25px_60px_rgba(37,99,235,0.16)] group flex flex-col justify-between transform hover:-translate-y-2 relative overflow-hidden space-y-6"
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2.5 text-slate-900 font-black text-lg group-hover:text-blue-600 transition-colors tracking-tight">
                  <Github size={22} className="text-slate-700 group-hover:text-blue-600 transition-colors" />
                  <span>{repo.title}</span>
                </div>
                <div className="w-10 h-10 rounded-xl bg-slate-100/80 border border-slate-200/60 flex items-center justify-center text-slate-700 group-hover:text-white group-hover:bg-blue-600 group-hover:border-blue-600 transition-all shadow-sm">
            ...
            <div className="flex items-center justify-between pt-5 border-t border-slate-100 text-xs font-mono text-slate-500 font-bold">
