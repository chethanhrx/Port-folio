    ...
    <section id="activity" className="py-28 px-6 relative z-10 max-w-7xl mx-auto">
      <div className="flex flex-col items-center text-center mb-16 relative">
        ...
        <h2 className="text-4xl sm:text-6xl font-black text-slate-900 tracking-tight mb-6">
          GitHub Activity & <br />
          <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-slate-900 bg-clip-text text-transparent">Open Source Telemetry</span>
        </h2>
        <p className="text-slate-600 max-w-2xl text-base sm:text-lg leading-relaxed font-medium">
          Live commit velocity and top starred repositories auto-pulled directly from my GitHub developer profile. Showing verified real-time star ratings.
        </p>
      </div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="p-8 rounded-3xl bg-white/90 backdrop-blur-2xl border border-slate-200/90 mb-14 shadow-[0_8px_30px_rgba(0,0,0,0.06)] overflow-x-auto"
      >
        <div className="flex items-center justify-between mb-8 min-w-[600px]">
          <div className="flex items-center gap-4">
            <div className="p-3.5 rounded-2xl bg-slate-100 border border-slate-200 text-slate-900 shadow-sm">
              <Github size={24} />
            </div>
            <div>
          ...
          <a
            ...
            className="px-5 py-2.5 rounded-xl bg-slate-100 border border-slate-200 text-xs font-mono text-slate-700 hover:text-slate-950 hover:border-slate-400 transition-all flex items-center gap-1.5 font-bold shadow-2xs"
          >
        ...
        <div className="w-full flex justify-center bg-slate-50/80 p-6 rounded-2xl border border-slate-200 min-w-[600px] shadow-inner">
          <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
        {reposList.map((repo, idx) => (
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-8 rounded-3xl bg-white/90 backdrop-blur-2xl border border-slate-200/90 hover:border-slate-400 transition-all duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:shadow-[0_25px_50px_rgba(0,0,0,0.14)] group flex flex-col justify-between transform hover:-translate-y-2 space-y-6"
          >
            <div>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5 text-slate-900 font-black text-lg group-hover:text-blue-600 transition-colors tracking-tight">
                  <Github size={22} className="text-slate-700 group-hover:text-blue-600" />
                  <span>{repo.title}</span>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-100 text-slate-700 group-hover:text-white group-hover:bg-slate-900 transition-all shadow-sm">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 text-xs font-mono text-slate-500 font-bold">
              ...
              <div className="flex items-center gap-4">
                <span className="flex items-center gap-1.5 text-slate-700 font-extrabold bg-amber-50 px-2.5 py-1 rounded-lg border border-amber-200/60">
                  <Star size={15} className="fill-amber-400 text-amber-500" />
                  {repo.stats?.stars || 0} Real Stars
                </span>
      ...
      <div className="flex justify-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="px-8 py-4 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-base shadow-lg transition-all duration-300 flex items-center gap-3 transform hover:-translate-y-1"
        >
          <Github size={20} />
