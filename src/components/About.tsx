    ...
    <section id="about" className="py-32 px-6 relative z-10 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mb-20 relative border-b border-[#262223] pb-12">
        <motion.div
          ...
          viewport={{ once: true }}
          className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-sm bg-[#181617] border border-[#9BCEC1]/40 text-[#9BCEC1] text-xs font-mono font-black mb-6 uppercase tracking-widest shadow-sm"
        >
        ...
        <h2 className="text-4xl sm:text-6xl font-black text-[#FFEBD3] tracking-tight mb-6 uppercase">
          ...
          <span className="text-[#FFB6A6]">Before Writing Code</span>
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
        ...
        >
          <div className="p-8 rounded-sm bg-[#181617] border border-[#262223] hover:border-[#FFB6A6] transition-all duration-500 space-y-6 shadow-2xl">
            {/* Avatar Header */}
            <div className="flex items-center gap-4 border-b border-[#262223] pb-6">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-[#9BCEC1] font-black tracking-wider uppercase">Java Full Stack Architect</p>
              </div>
            </div>

            <p className="text-[#FFEBD3]/85 leading-relaxed text-sm sm:text-base font-normal">
              I am a Bachelor of Computer Applications (BCA) graduate specializing in high-concurrency Java Full Stack Engineering at <span className="text-[#141213] font-black bg-[#9BCEC1] px-2.5 py-1 rounded-sm">JSpiders, Bangalore</span>.
            </p>
            <p className="text-[#FFEBD3]/75 leading-relaxed text-sm sm:text-base font-normal">
              With deep expertise in <span className="text-[#FFEBD3] font-black">Java, Spring Boot, REST APIs, Microservices, React, PostgreSQL, Kafka, Redis, and Elasticsearch</span>, I engineer backend ecosystems built to withstand heavy enterprise traffic.
            </p>
          ...
          <div className="p-7 rounded-sm bg-[#181617] border border-[#262223] flex items-center gap-4 hover:border-[#67A2C5] transition-all duration-300 shadow-xl">
            <div className="p-3.5 rounded-sm bg-[#141213] border border-[#67A2C5]/40 text-[#67A2C5] flex-shrink-0">
              <BookOpen size={20} />
            </div>
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-[#67A2C5] font-black block mb-1">
        ...
        >
          {SKILL_CATEGORIES.map((category, idx) => (
            <GravityCard
              key={idx}
              className="p-7 rounded-sm bg-[#181617] border border-[#262223] hover:border-[#FFB6A6] transition-all duration-500 flex flex-col justify-between group shadow-xl"
            >
              <div>
                <h4 className="text-xs font-mono uppercase tracking-widest font-black mb-5 flex items-center gap-2.5 text-[#9BCEC1] border-b border-[#262223] pb-3">
                  <Terminal size={16} className="group-hover:text-[#FFB6A6] transition-colors" />
                  {category.title}
                </h4>
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, sIdx) => (
                    <span
                      key={sIdx}
                      className="px-3 py-1.5 rounded-sm bg-[#141213] border border-[#262223] text-xs font-mono font-bold text-[#FFEBD3]/90 hover:border-[#FFB6A6] hover:text-[#FFB6A6] transition-all uppercase"
                    >
                      {skill.name}
                    </span>
                  ))}
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="p-8 sm:p-10 rounded-sm bg-[#181617] border border-[#262223] hover:border-[#FFB6A6] flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden transition-all duration-500 shadow-2xl"
      >
        <div className="flex items-center gap-5 text-center md:text-left relative z-10">
          <div className="w-14 h-14 rounded-sm bg-[#141213] border border-[#FFB6A6]/40 flex items-center justify-center text-[#FFB6A6] flex-shrink-0">
            <Sparkles size={24} />
          </div>
          <div>
            ...
            <p className="text-sm text-[#FFEBD3]/75 font-normal">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2.5 relative z-10">
          {AI_TOOLS_LIST.map((tool, idx) => (
            <span
              key={idx}
              className="px-4 py-2.5 rounded-sm bg-[#141213] border border-[#262223] text-xs font-mono font-black text-[#FFEBD3] hover:border-[#FFB6A6] hover:text-[#FFB6A6] transition-all duration-300 uppercase tracking-wider"
            >
              {tool}
            </span>
          ))}
